...
anos_selecionadas = st.sidebar.multiselect('Ano', anos_disponiveis, default=anos_disponiveis)
...
tamanhos_selecionadados = st.sidebar.multiselect('Tamanho da Empresa', tamanhos_disponiveis, default=tamanhos_disponiveis)

#Filtragem do DataFrame
df_filtrado = df[
    (df['ano'].isin(anos_selecionadas)) &
    (df['senioridade'].isin(senioridade_selecionadas)) &
    (df['contrato'].isin(contratos_selecionados)) &
    (df['tamanho_empresa'].isin(tamanhos_selecionadados))
]

# Titulo do conteúdo
st.title('🎲 Dashboard de Análise de Salários na Área de Dados')
st.markdown('Explore os dados salariais na área de dados nos últimos anos. Utilize os filtros à esquerda para refinar sua ánalise')
